    ...
    def _forward_list(self, x_list: List[Tensor], rope_list=None) -> List[Tensor]:
        ...
        if self.training and self.sample_drop_ratio > 0.0:
            ...
            x_attn_list = [
                ...
                for x, residual_1, indices_1, residual_scale_factor in zip(x_list, residual_1_list, indices_1_list, residual_scale_factors)
            ]
            ...
            x_ffn = [
                ...
                for x_attn, residual_2, indices_2, residual_scale_factor in zip(x_attn_list, residual_2_list, indices_2_list, residual_scale_factors)
            ]
        else:
            x_out = []
